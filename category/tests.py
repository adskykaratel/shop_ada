...
from .views import CategorViewSet
...
class CategoryTest(APITestCase):
    ...
    def test_get_category(self):
        ...
        view = CategorViewSet.as_view({'get': 'list'})
    ...
    def test_post_category(self):
        ...
        view = CategorViewSet.as_view({'post': 'create'})
        response = view(request)
    ...
    def test_update_category(self):
        ...
        force_authenticate(request, user=self.user)
        view = CategorViewSet.as_view({'patch': 'partial_update'})
    ...
    def test_delete_category(self):
        ...
        force_authenticate(request, user=self.user)
        view = CategorViewSet.as_view({'delete': 'destroy'})
        response = view(request, slug=category.slug)
